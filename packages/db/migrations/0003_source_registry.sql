...
VALUES
  ('ocds_peru', 'OCDS Peru — Open Contracting Data Registry', 'https://data.open-contracting.org/es/publication/135', 'bulk_download', 'P0', 'planned', 'Anthony', 'Direct download JSONL.gz/CSV by year'),
  ('sunat_padron', 'SUNAT — Padron Reducido del RUC', 'https://www.sunat.gob.pe/descargaPRR/mrc137_padron_reducido.html', 'bulk_download', 'P0', 'planned', 'Anthony', 'ZIP download, parse TXT pipe-delimited ISO-8859-1'),
  ('sunat_multi_ruc', 'SUNAT — Consulta multiple de RUC', 'https://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsmulruc/jrmS00Alias', 'form_scraping', 'P1', 'planned', 'Anthony', 'Form POST with ZIP file, CAPTCHA, max 100 RUC'),
  ('contraloria_sanciones', 'Contraloria — Registro de sanciones', 'https://www.gob.pe/institucion/contraloria/informes-publicaciones/2706979-registro-de-sanciones-inscritas-y-vigentes', 'playwright', 'P0', 'planned', 'John', 'Playwright download intercept XLSX'),
  ('cgr_informes', 'CGR — Buscador de informes de control', 'https://appbp.contraloria.gob.pe/BuscadorCGR/informes/Avanzado.html', 'playwright', 'P1', 'planned', 'John', 'Playwright XHR intercept + PDF'),
  ('seace_oece', 'SEACE/OECE — Portal datos abiertos', 'https://bi.seace.gob.pe/pentaho/api/repos/:public:portal:datosabiertos.html/content?userid=public&password=key', 'bulk_download', 'P0', 'planned', 'John', 'Pentaho direct download CSV/XLSX by category/year'),
  ('ley_32069', 'Ley 32069 — Ley General de Contrataciones Publicas', 'https://www.gob.pe/institucion/oece/colecciones/45029-ley-n-32069-ley-general-de-contrataciones-publicas-y-su-reglamento', 'reference', 'P0', 'active', 'Miguel', 'PDF legal reference, index for RAG'),
  ('sidji_dji', 'SIDJI — Declaraciones Juradas de Intereses', 'https://appdji.contraloria.gob.pe/djic/', 'playwright', 'P1', 'planned', 'Miguel', 'On-demand only, CAPTCHA, no mass scraping'),
  ('mef_transparencia', 'MEF — Transparencia Economica', 'https://www.mef.gob.pe/es/portal-de-transparencia-economica', 'api', 'P1', 'planned', 'Anthony', 'CKAN API or controlled scraping'),
  ('mef_datos_abiertos', 'MEF — Datos Abiertos', 'https://datosabiertos.mef.gob.pe/dataset', 'ckan', 'P1', 'planned', 'Anthony', 'CKAN API package_list / package_search'),
  ('onpe_claridad', 'ONPE — Claridad', 'https://claridadportal.onpe.gob.pe/', 'playwright', 'P1', 'planned', 'Noelia', 'XHR intercept, search by RUC/DNI/org'),
  ('jne_voto_informado', 'JNE — Voto Informado', 'https://votoinformado.jne.gob.pe/', 'playwright', 'P1', 'planned', 'Noelia', 'XHR intercept Angular SPA'),
  ('jne_plataforma', 'JNE — Plataforma Electoral', 'https://plataformaelectoral.jne.gob.pe/', 'playwright', 'P1', 'planned', 'Noelia', 'XHR intercept'),
  ('congreso_leyes', 'Congreso — Archivo Digital de Legislacion', 'https://www.leyes.congreso.gob.pe/', 'form_scraping', 'P1', 'planned', 'Miguel', 'ASP.NET WebForms, HTML table + PDF'),
  ('congreso_proyectos', 'Congreso — Proyectos de Ley', 'https://www.congreso.gob.pe/', 'form_scraping', 'P2', 'planned', 'Miguel', 'Controlled scraping + PDFs'),
  ('sunarp_conoce', 'SUNARP — Conoce Aqui', 'https://conoce-aqui.sunarp.gob.pe/', 'manual', 'P2', 'planned', 'John', 'Requires DNI/date/partida, no mass scraping'),
  ('sunarp_sprl', 'SUNARP — SPRL', 'https://sprl.sunarp.gob.pe/', 'manual', 'P3', 'planned', 'John', 'Paid access, review TOS first'),
  ('sunarp_pj', 'SUNARP — Directorio Personas Juridicas', 'https://www.sunarp.gob.pe/dn-personas-juridicas.asp', 'form_scraping', 'P2', 'planned', 'John', 'Controlled search by denomination'),
  ('poder_judicial', 'Poder Judicial', 'https://www.pj.gob.pe/', 'manual', 'P3', 'planned', 'Miguel', 'Only firm public sentences, human review'),
  ('ministerio_publico', 'Ministerio Publico', 'https://www.gob.pe/mpfn', 'manual', 'P3', 'planned', 'Miguel', 'Official notes only, no automation'),
  ('ojo_publico_funes', 'Ojo Publico — FUNES', 'https://ojo-publico.com/especiales/funes/metodologia.html', 'reference', 'P1', 'active', 'John', 'Methodology reference, do not copy data'),
  ('open_contracting_memoria', 'Open Contracting — Memoria', 'https://www.open-contracting.org/es/2020/09/10/memoria-contra-la-corrupcion-datos-y-algoritmos-para-investigar-compras-publicas/', 'reference', 'P1', 'active', 'Anthony', 'Methodology reference'),
  ('convoca_contrataciones', 'Convoca — Contrataciones', 'https://convoca.pe/tags/contrataciones-publicas', 'form_scraping', 'P1', 'planned', 'Noelia', 'Drupal 9, save only URL/title/snippet'),
  ('convoca_pandemia', 'Convoca — Expedientes Pandemia', 'https://convoca.pe/especiales/expedientes-de-la-pandemia', 'form_scraping', 'P2', 'planned', 'Noelia', 'Manual/semiautomated enrichment')
